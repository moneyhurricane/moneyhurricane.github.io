...
function preload() {
  ...
  startButton2 = loadImage('images/startButton.png');
  startButton3 = loadImage('images/startButton.png');
  startButton4 = loadImage('images/startButtonRed.png');
  welcomeText = loadImage('images/welcomeText.png');
  gameDesc = loadImage('images/gameDesc.png');
  gameInstruct = loadImage('images/gameInstruct.png');
  wasdInstruct = loadAnimation('images/wasdUp.png', 'images/wasdLeft.png', 'images/wasdDown.png', 'images/wasdRight.png');
  arrowInstruct = loadAnimation('images/arrowUp.png', 'images/arrowLeft.png', 'images/arrowDown.png', 'images/arrowRight.png');
  minivan = loadImage('images/minivan.png');
  liveLaughLove = loadImage('images/liveLaughLove.png');
  PBJ = loadImage('images/PBJ.png');
  house = loadImage('images/house.png');
  snowPlatform = loadImage('images/snowPlatform.png');
  snowPlatform2 = loadImage('images/snowPlatform.png');
  barbara = loadImage('images/barbara.png');
  characterStand = loadImage('images/characterStandRight.png');
  characterRunLeft = loadAnimation('images/characterRun1Right.png', 'images/characterRun2Right.png');
  characterRunRight = loadAnimation('images/characterRun1Left.png', 'images/characterRun2Left.png');
  characterJumpRight = loadImage('images/characterJumpRight.png');
  characterJumpLeft = loadImage('images/characterJumpLeft.png');
  healthBar = loadImage('images/healthBar.png');
  healthBar2 = loadImage('images/healthBar.png');
}
